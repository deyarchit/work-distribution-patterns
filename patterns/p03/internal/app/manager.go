...
// ManagerConfig holds runtime parameters for the Pattern 3 manager process.
...
// NewManager wires the Pattern 3 manager and returns a configured Echo router.
// The router exposes task CRUD, SSE stream, and WebSocket worker registration endpoint.
