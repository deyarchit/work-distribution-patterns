...
func TestP6Integration(t *testing.T) {
	...
	// The gocloud NATS driver expects the URL scheme "nats://".
	brokerURL := natsURL
	...
	go app.RunWorker(ctx, app.WorkerConfig{BrokerURL: brokerURL, MaxStageDuration: 100})
